...
class r extends HTMLElement {
    ...
    constructor() {
        super(),
        this.delegate = new r.delegateConstructor(this)
    }
    connectedCallback() {
...
function n(e) {
        ...
        return e;
    {
        ...
        t.async = !1,
        function(e, t) {
            for (const {name: s, value: r} of t.attributes)
                e.setAttribute(s, r)
        }(t, e),
        t
    }
...
function o(e, {target: t, cancelable: s, detail: r}={}) {
    ...
    return t && t.isConnected ? t.dispatchEvent(i) : document.documentElement.dispatchEvent(i),
    i
}
function a(e) {
    e.preventDefault(),
...
function A(e, t) {
    if (e instanceof Element)
        return e.closest(t) || A(e.assignedSlot || e.getRootNode()?.host, t)
}
function R(e) {
...
function Y(e) {
    const t = [];
    for (const [s,r] of e)
        r instanceof File || t.push([s, r]);
    return t
}
function Z(e, t) {
    const s = new URLSearchParams(Y(t));
    return e.search = s.toString(),
    e
}
class ee {
    started = !1;
...
class ie {
    ...
    async start() {
        ...
        if ("string" == typeof s) {
            ...
            if (!await e(s, this.formElement, this.submitter))
                return
        }
        if (this.state == e)
            return this.state = t,
    ...
    requestSucceededWithResponse(e, t) {
        ...
        this.requestMustRedirect(e) && function(e) {
    ...
    submitBubbled = e => {
        if (!e.defaultPrevented) {
            ...
            t && function(e, t) {
                ...
                return T(s)
            }(t, s) && this.delegate.willSubmitForm(t, s) && (e.preventDefault(),
            e.stopImmediatePropagation(),
...
class le {
    ...
    async render(e) {
        ...
        if (s)
            ...
            n && this.invalidate(e.reloadReason)
    }
    invalidate(e) {
...
class ue {
    ...
    clickBubbled = e => {
        if (e instanceof MouseEvent && this.clickEventIsSignificant(e)) {
            ...
            if (t && T(t.target)) {
                const s = P(t);
                this.delegate.willFollowLinkToLocation(t, s, e) && (e.preventDefault(),
                this.delegate.followedLinkToLocation(t, s))
            }
        }
    }
    ;
...
class me {
    constructor(e, t) {
        this.delegate = e,
        this.linkInterceptor = new ue(this,t)
    }
    start() {
...
class fe {
    ...
    leavingBardo(e) {
        e.contains(this.#c) && this.#c instanceof HTMLElement && (this.#c.focus(),
        this.#c = null)
    }
    ...
    scrollFrameIntoView() {
        if (this.currentElement.autoscroll || this.newElement.autoscroll) {
            const s = this.currentElement.firstElementChild
              , r = (e = this.currentElement.getAttribute("data-autoscroll-block"),
            t = "end",
...
var be = function() {
    ...
    const s = function() {
        function e(e, t, s, i) {
            if (!1 === i.callbacks.beforeNodeAdded(t))
                return null;
            if (i.idMap.has(t)) {
                const n = document.createElement(t.tagName);
                return e.insertBefore(n, s),
                r(n, t, i),
        ...
        function s(e, t) {
            if (e.idMap.has(t))
                ...
                if (!1 === e.callbacks.beforeNodeRemoved(t))
                    return;
        ...
        return function(o, a, c, l=null, h=null) {
            a instanceof HTMLTemplateElement && c instanceof HTMLTemplateElement && (a = a.content,
            c = c.content),
            l ||= a.firstChild;
      ...
      , r = function() {
        function e(e, s, r, i) {
            ...
            if (n !== e[r]) {
                ...
                o || (e[r] = s[r]),
                n ? o || e.setAttribute(r, "") : t(r, e, "remove", i) || e.removeAttribute(r)
            }
        }
        function t(e, t, s, r) {
            ...
            return a.ignoreActive && n === document.activeElement ? null : (!1 === a.callbacks.beforeNodeMorphed(n, o) || (n instanceof HTMLHeadElement && a.head.ignore || (n instanceof HTMLHeadElement && "morph" !== a.head.style ? i(n, o, a) : (!function(s, i, n) {
                ...
                if (1 === o) {
                    const o = s
                      ...
                      , l = a.attributes;
                    for (const e of l)
                        t(e.name, o, "update", n) || o.getAttribute(e.name) !== e.value && o.setAttribute(e.name, e.value);
                    for (let e = c.length - 1; 0 <= e; e--) {
                        const s = c[e];
                        if (s && !a.hasAttribute(s.name)) {
                            if (t(s.name, o, "remove", n))
                                continue;
                    ...
                    r(o, n) || function(s, r, i) {
                        if (s instanceof HTMLInputElement && r instanceof HTMLInputElement && "file" !== r.type) {
                            ...
                            e(s, r, "checked", i),
                            e(s, r, "disabled", i),
                            r.hasAttribute("value") ? o !== n && (t("value", s, "update", i) || (s.setAttribute("value", n),
                            s.value = n)) : t("value", s, "remove", i) || (s.value = "",
    ...
    function i(e, t, s) {
        ...
        for (const t of e.children) {
            ...
            e || c ? r ? i.push(t) : (a.delete(t.outerHTML),
            n.push(t)) : "append" === s.head.style ? r && (i.push(t),
            o.push(t)) : !1 !== s.head.shouldRemove(t) && i.push(t)
        }
        o.push(...a.values());
        let c = [];
        for (const t of o) {
        ...
        for (const t of i)
            !1 !== s.callbacks.beforeNodeRemoved(t) && (e.removeChild(t),
            ...
            const c = a(t)
              ...
              , h = function(e, t) {
                ...
                const {id: r, selectionStart: i, selectionEnd: n} = s
                  , o = t();
                r && r !== document.activeElement?.id && (s = e.target.querySelector(`#${r}`),
                s?.focus());
                ...
                return r(e)
            }(l, e, c, (t => "innerHTML" === t.morphStyle ? (s(t, e, c),
            Array.from(e.childNodes)) : function(e, t, r) {
                const i = a(t);
                let n = Array.from(i.childNodes);
                const o = n.indexOf(t)
                  , c = n.length - (o + 1);
                return s(e, i, r, t, t.nextSibling),
...
class Ee {
    ...
    fadeProgressElement(e) {
        ...
        setTimeout(e, 1.5 * Ee.animationDuration)
    }
...
class Ce {
    ...
    #d = Promise.resolve();
    renderChange(e, t) {
        return e && this.viewTransitionsAvailable && !this.#h ? (this.#h = !0,
...
class Ue {
    ...
    constructor(e, t, s, r={}) {
        this.delegate = e,
        this.location = t,
        this.restorationIdentifier = s || m();
        const {action: i, historyChanged: n, referrer: o, snapshot: a, snapshotHTML: c, response: l, visitCachedSnapshot: h, willRender: d, updateHistory: u, shouldCacheSnapshot: p, acceptsStreamResponse: f, direction: g} = {
            ...Pe,
            ...r
        };
        this.action = i,
    ...
    start() {
        this.state == qe && (this.recordTimingMetric(ke),
        this.state = He,
        this.adapter.visitStarted(this),
        this.delegate.visitStarted(this))
    }
    cancel() {
        this.state == He && (this.request && this.request.cancel(),
        this.cancelRender(),
        this.state = Be)
    }
    complete() {
        this.state == He && (this.recordTimingMetric(Ie),
    ...
    issueRequest() {
        this.hasPreloadedResponse() ? this.simulateRequest() : this.shouldIssueRequest() && !this.request && (this.request = new X(this,z.get,this.location),
        ...
        if (this.response) {
            ...
            this.render((async () => {
                ...
                _e(e) && null != t) {
                    ...
                    await this.view.renderError(Te.fromHTMLString(t), this),
                    this.adapter.visitRendered(this),
                    this.fail()
            }
            ))
    ...
    getPreloadedSnapshot() {
        if (this.snapshotHTML)
            return Te.fromHTMLString(this.snapshotHTML)
    }
    hasCachedSnapshot() {
...
class tt {
    ...
    startVisit(e, t, s={}) {
        this.stop(),
        this.currentVisit = new Ue(this,I(e),t,{
    ...
    submitForm(e, t) {
        this.stop(),
        this.formSubmission = new ie(this,e,t,!0),
...
class ot {
    ...
    start() {
        this.started || (this.stage == st && (this.stage = rt),
...
class ft extends le {
    ...
    renderPage(e, t=!1, s=!0, r) {
        ...
        return i.shouldRender ? r?.changeHistory() : this.forceReloaded = !0,
        this.render(i)
    }
    renderError(e, t) {
        t?.changeHistory();
    ...
    async cacheSnapshot(e=this.snapshot) {
        if (e.isCacheable) {
            ...
            await h();
            const s = e.clone();
            return this.snapshotCache.put(t, s),
            s
        }
    }
...
class bt {
    ...
    #P(e) {
        !function(e, t) {
            let s = w(e);
            s || (s = document.createElement("meta"),
  ...
  , wt = new class {
    ...
    visit(e, t={}) {
        ...
        if (s instanceof r) {
            ...
            this.navigator.proposeVisit(I(e), t)
    }
    refresh(e, t) {
    ...
    visitStarted(e) {
        e.acceptsStreamResponse || (f(document.documentElement),
    ...
    allowsImmediateRender({element: e}, t) {
        const s = this.notifyApplicationBeforeRender(e, t)
          , {defaultPrevented: r, detail: {render: i}} = s;
        return this.view.renderer && i && (this.view.renderer.renderElement = i),
        !r
    }
...
const Nt = {
    ...
    update() {
        const e = this.getAttribute("method");
        this.targetElements.forEach((t => {
            "morph" === e ? Se(t, this.templateContent) : (t.innerHTML = "",
...
r.delegateConstructor = class {
    ...
    sourceURLChanged() {
        this.#D("src") || (this.element.isConnected && (this.complete = !1),
        (this.loadingStyle == s.eager || this.#H) && this.#N())
    }
    sourceURLReloaded() {
        const {refresh: e, src: t} = this.element;
        return this.#O = t && "morph" === e,
    ...
    loadingStyleChanged() {
        this.loadingStyle == s.lazy ? this.appearanceObserver.start() : (this.appearanceObserver.stop(),
        this.#N())
    }
    async #N() {
        this.enabled && this.isActive && !this.complete && this.sourceURL && (this.element.loaded = this.#x(I(this.sourceURL)),
        this.appearanceObserver.stop(),
    ...
    elementAppearedInViewport(e) {
        this.proposeVisitIfNavigatedWithAction(e, S(e)),
        this.#N()
    }
    ...
    formSubmitted(e, t) {
        this.formSubmission && this.formSubmission.stop(),
        this.formSubmission = new ie(this,e,t);
    ...
    async extractForeignFrameElement(e) {
        ...
        try {
            if (t = Ot(e.querySelector(`turbo-frame#${s}`), this.sourceURL),
            t)
                return t;
            if (t = Ot(e.querySelector(`turbo-frame[src][recurse~=${s}]`), this.sourceURL),
            t)
    ...
    #U(e, t) {
        ...
        if (e instanceof HTMLFormElement && !this.#X(e, t))
            return !1;
        if (!this.enabled || "_top" == s)
            return !1;
        if (s) {
            const e = Bt(s);
            if (e)
...
addEventListener("turbo:before-fetch-request", (function(e) {
    if (e.target instanceof HTMLFormElement) {
        const {target: t, detail: {fetchOptions: s}} = e;
        t.addEventListener("turbo:submit-start", ( ({detail: {formSubmission: {submitter: e}}}) => {
            ...
            /get/i.test(i) || (/post/i.test(i) ? r.delete("_method") : r.set("_method", i),
            s.method = "post")
        }
        ), {
            once: !0
...
class Zt {
    ...
    start() {
        this.isRunning() || (this.startedAt = Qt(),
    ...
    stop() {
        this.isRunning() && (this.stoppedAt = Qt(),
        this.stopPolling(),
    ...
    recordDisconnect() {
        this.disconnectedAt = Qt(),
        Kt.log("ConnectionMonitor recorded disconnect")
    }
    startPolling() {
        this.stopPolling(),
        this.poll()
    ...
    reconnectIfStale() {
        this.connectionIsStale() && (Kt.log(`ConnectionMonitor detected stale connection. reconnectAttempts = ${this.reconnectAttempts}, time stale = ${Yt(this.refreshedAt)} s, stale threshold = ${this.constructor.staleThreshold} s`),
        this.reconnectAttempts++,
        this.disconnectedRecently() ? Kt.log(`ConnectionMonitor skipping reopening recent disconnect. time disconnected = ${Yt(this.disconnectedAt)} s`) : (Kt.log("ConnectionMonitor reopening"),
    ...
    visibilityDidChange() {
        "visible" === document.visibilityState && setTimeout(( () => {
            !this.connectionIsStale() && this.connection.isOpen() || (Kt.log(`ConnectionMonitor reopening stale connection on visibilitychange. visibilityState = ${document.visibilityState}`),
            this.connection.reopen())
        }
        ), 200)
    }
...
class os {
    ...
    open() {
        if (this.isActive())
            return Kt.log(`Attempted to open WebSocket, but existing socket is ${this.getState()}`),
            !1;
        {
            const e = [...rs, ...this.consumer.subprotocols || []];
            return Kt.log(`Opening WebSocket, current state is ${this.getState()}, subprotocols: ${e}`),
    ...
    reopen() {
        if (Kt.log(`Reopening WebSocket, current state is ${this.getState()}`),
        !this.isActive())
            return this.open();
        try {
            return this.close()
    ...
    getState() {
        if (this.webSocket)
            for (let e in Xt.WebSocket)
                if (Xt.WebSocket[e] === this.webSocket.readyState)
...
os.prototype.events = {
    message(e) {
        ...
        case ss.disconnect:
            return Kt.log(`Disconnecting. Reason: ${r}`),
            this.close({
                allowReconnect: i
            });
        case ss.ping:
    ...
    open() {
        if (Kt.log(`WebSocket onopen event, using '${this.getProtocol()}' subprotocol`),
        this.disconnected = !1,
        !this.isProtocolSupported())
            return Kt.log("Protocol is unsupported. Stopping monitor and disconnecting."),
            this.close({
                allowReconnect: !1
            })
    },
    close(e) {
        if (Kt.log("WebSocket onclose event"),
        !this.disconnected)
...
var ls = class {
    ...
    guarantee(e) {
        -1 == this.pendingSubscriptions.indexOf(e) ? (Kt.log(`SubscriptionGuarantor guaranteeing ${e.identifier}`),
        this.pendingSubscriptions.push(e)) : Kt.log(`SubscriptionGuarantor already guaranteeing ${e.identifier}`),
    ...
    retrySubscribing() {
        this.retryTimeout = setTimeout(( () => {
            this.subscriptions && "function" == typeof this.subscriptions.subscribe && this.pendingSubscriptions.map((e => {
                Kt.log(`SubscriptionGuarantor resubscribing ${e.identifier}`),
...
class hs {
    ...
    notify(e, t, ...s) {
        let r;
        return r = "string" == typeof e ? this.findAll(e) : [e],
    ...
    confirmSubscription(e) {
        Kt.log(`Subscription confirmed ${e}`),
...
class ds {
    constructor(e) {
        this._url = e,
        this.subscriptions = new hs(this),
        this.connection = new as(this),
        this.subprotocols = []
    }
    get url() {
        return us(this._url)
